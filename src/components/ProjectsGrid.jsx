...
export default function ProjectsGrid() {
  return (
    <section id="projects" style={{ minHeight: "100vh", paddingTop: "var(--space-2xl)", paddingBottom: "var(--space-xl)", paddingLeft: "var(--space-md)", paddingRight: "var(--space-md)" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(min(100%, 320px), 1fr))", gap: "var(--space-md)", fontSize: "0.87rem", justifyContent: "center" }}>
        ...
        <div id="nf-scautoqc-card" className="project-card reveal" tabIndex={0} data-category="pipeline">
          ...
          <h3 style={{ fontSize: "1.3em", color: "var(--foreground)", marginBottom: "var(--space-sm)", fontWeight: "700" }}>nf-scautoqc</h3>
        ...
        {/* nf-larry */}
        <div id="nf-larry-card" className="project-card reveal" tabIndex={0} data-category="pipeline" style={{ transitionDelay: "0.1s" }}>
          <div className="category-label" style={{ display: "flex", alignItems: "center", gap: "10px", fontFamily: "var(--font-mono)", fontSize: "0.85em", marginBottom: "var(--space-sm)", fontWeight: "600" }}>
            <svg role="img" viewBox="0 0 24 24" fill="currentColor" width="16px" height="16px" style={{ transform: "translateY(-1px)" }} xmlns="http://www.w3.org/2000/svg"><title>Nextflow</title><path d="M.005 4.424V0c6.228.259 11.227 5.268 11.477 11.506H7.058C6.828 7.715 3.786 4.673.005 4.424m7.082 8.089h4.424C11.251 18.741 6.242 23.741.005 23.99v-4.423c3.79-.231 6.832-3.273 7.082-7.054m9.826-1.036h-4.424C12.749 5.249 17.758.25 23.995 0v4.424c-3.79.23-6.832 3.263-7.082 7.053m7.082 8.099V24c-6.228-.259-11.227-5.268-11.477-11.506h4.424c.23 3.791 3.272 6.833 7.053 7.082" /></svg>
            PIPELINE / NEXTFLOW
          </div>
          <h3 style={{ fontSize: "1.3em", color: "var(--foreground)", marginBottom: "var(--space-sm)", fontWeight: "700" }}>nf-larry</h3>
          <p style={{ opacity: 0.85, lineHeight: "1.6", marginBottom: "1.5rem", flexGrow: 1, color: "var(--foreground)" }}>
        ...
        {/* nf-cellsnplite */}
        <div id="nf-cellsnplite-card" className="project-card reveal" tabIndex={0} data-category="pipeline" style={{ transitionDelay: "0.15s" }}>
          <div className="category-label" style={{ display: "flex", alignItems: "center", gap: "10px", fontFamily: "var(--font-mono)", fontSize: "0.85em", marginBottom: "var(--space-sm)", fontWeight: "600" }}>
            <svg role="img" viewBox="0 0 24 24" fill="currentColor" width="16px" height="16px" style={{ transform: "translateY(-1px)" }} xmlns="http://www.w3.org/2000/svg"><title>Nextflow</title><path d="M.005 4.424V0c6.228.259 11.227 5.268 11.477 11.506H7.058C6.828 7.715 3.786 4.673.005 4.424m7.082 8.089h4.424C11.251 18.741 6.242 23.741.005 23.99v-4.423c3.79-.231 6.832-3.273 7.082-7.054m9.826-1.036h-4.424C12.749 5.249 17.758.25 23.995 0v4.424c-3.79.23-6.832 3.263-7.082 7.053m7.082 8.099V24c-6.228-.259-11.227-5.268-11.477-11.506h4.424c.23 3.791 3.272 6.833 7.053 7.082" /></svg>
            PIPELINE / NEXTFLOW
          </div>
          <h3 style={{ fontSize: "1.3em", color: "var(--foreground)", marginBottom: "var(--space-sm)", fontWeight: "700" }}>nf-cellsnplite</h3>
          <p style={{ opacity: 0.85, lineHeight: "1.6", marginBottom: "1.5rem", flexGrow: 1, color: "var(--foreground)" }}>
        ...
        <div id="curation-card" className="project-card reveal" tabIndex={0} data-category="resource" style={{ transitionDelay: "0.2s" }}>
          <div className="category-label" style={{ display: "flex", alignItems: "center", gap: "10px", fontFamily: "var(--font-mono)", fontSize: "0.85em", marginBottom: "var(--space-sm)", fontWeight: "600" }}>
          ...
          <h3 style={{ fontSize: "1.3em", color: "var(--foreground)", marginBottom: "var(--space-sm)", fontWeight: "700" }}>CELLxGENE Discover Curation</h3>
          <p style={{ opacity: 0.85, lineHeight: "1.6", marginBottom: "1.5rem", flexGrow: 1, color: "var(--foreground)" }}>
            Contributed to the curation of the <a href="https://www.covid19cellatlas.org/" target="_blank" rel="noopener noreferrer" className="hover-link focus-visible" style={{ textDecoration: "underline", textDecorationStyle: "dotted", fontWeight: "500", color: "inherit", transition: "color 0.2s" }} onMouseOver={(e) => e.currentTarget.style.color = "var(--accent-resource)"} onMouseOut={(e) => e.currentTarget.style.color = "inherit"}>COVID-19 Cell Atlas</a> for the CELLxGENE Discover portal, enabling broad access to vital single-cell datasets.
          </p>
        ...
        <div id="benchmarking-card" className="project-card reveal" tabIndex={0} data-category="publication" style={{ transitionDelay: "0.3s" }}>
          <div className="category-label" style={{ display: "flex", alignItems: "center", gap: "10px", fontFamily: "var(--font-mono)", fontSize: "0.85em", marginBottom: "var(--space-sm)", fontWeight: "600" }}>
          ...
          <h3 style={{ fontSize: "1.3em", color: "var(--foreground)", marginBottom: "var(--space-sm)", fontWeight: "700" }}>Benchmarking scRNA-seq Visualisation Tools</h3>
          <p style={{ opacity: 0.85, lineHeight: "1.6", marginBottom: "1.5rem", flexGrow: 1, color: "var(--foreground)" }}>
